...
const ServicesPage = () => {
  return (
    <>
      <section className="dark:bg-gray-500 w-full border-b py-12 ">
        <div className=" mx-auto flex flex-wrap items-center justify-between pb-12">
          <h2 className="w-full my-2 text-xl font-black leading-tight text-center dark:text-white lg:mt-8">
            Our Customers / Featured in
          </h2>

          <div className="flex flex-1 flex-wrap max-w-4xl mx-auto items-center justify-between text-xl dark:text-white font-bold opacity-75">
            <span className="w-1/2 p-4 md:w-auto flex items-center">
              <svg
                className="h-10 w-10 mr-4 fill-current dark:text-white dark:opacity-100 opacity-75"
      ...
      <section className=" dark:bg-violet-700 bg-gray-100 border-b py-8">
        <div className=" mx-auto flex flex-wrap pt-4 pb-12">
          <h2 className="w-full my-2 text-5xl font-black leading-tight text-center ">
            Title
          </h2>
        </div>
        <div className=" px-8 flex flex-col md:flex-row md:gap-4 justify-center items-center">
          <Card />
          <Card />
          <Card />
        </div>
