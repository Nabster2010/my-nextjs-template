...
const Header = () => {
  ...
  return (
    <nav className="font-cairo bg-white border-gray-200 px-4 md:px-8 sm:px-4 py-2.5  dark:bg-gray-800">
        ...
        >
          <ul className="flex flex-col mt-4 md:flex-row md:items-center md:space-x-8 md:mt-0 md:text-sm md:font-medium ">
            <li>
              <a
                href="#"
                className="block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:ml-8"
                aria-current="page"
              >
                {t.nav.home}
              </a>
